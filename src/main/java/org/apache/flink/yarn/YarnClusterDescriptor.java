    ...
    private ApplicationReport startAppMaster(
        ...
        if (userJarInclusion == YarnConfigOptions.UserJarInclusion.FIRST) {
            for (String userClassPath : userClassPaths) {
                classPathBuilder.append(userClassPath).append(ApplicationConstants.CLASS_PATH_SEPARATOR);
            }
        }
        for (String classPath : systemClassPaths) {
            classPathBuilder.append(classPath).append(ApplicationConstants.CLASS_PATH_SEPARATOR);
        }
        ...
        if (jobGraph != null) {
            ...
            try {
                ...
                fileUploader.registerSingleLocalResource(
                        ...
                        true,
                        false);
                classPathBuilder.append(jobGraphFilename).append(ApplicationConstants.CLASS_PATH_SEPARATOR);
            } catch (Exception e) {
        ...
        try {
            ...
            fileUploader.registerSingleLocalResource(
                    ...
                    true,
                    true);
            classPathBuilder.append("flink-conf.yaml").append(ApplicationConstants.CLASS_PATH_SEPARATOR);
        } finally {
